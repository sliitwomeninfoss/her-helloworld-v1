            ...
            <div className="col-lg-3 col-md-6 col-xs-12">
              ...
              <div className="team-item wow fadeInUp" data-wow-delay="0.2s">
                  ...
                  <div className="team-overlay">
                    <div className="overlay-social-icon text-center">
                      <ul className="social-icons">
                        ...
                        <li>
                          <a href="#">
                            <i className="lni-google" aria-hidden="true" />
                          </a>
                        </li>
                        <li>
                          <a href="#">
                        ...
                        <li>
                          <a href="#">
                            <i className="lni-pinterest" aria-hidden="true" />
                          </a>
                        </li>
                      </ul>
                    </div>
                ...
                <div className="info-text">
                  <h3>
                    <a href="#">SEWVANDI WICKRAMASINGHE</a>
                  </h3>
                  <p>
                    SLIIT Women in FOSS Lead, Associate Software Engineer at
                    Orel IT
                  </p>
                </div>
              </div>
